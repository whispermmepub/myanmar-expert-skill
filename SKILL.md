...
## 🆕 Added: လဲ→လည်း, လ→ရ, Character Name Variations

### Character Name Consistency Check

ဇာတ်ကောင်နာမည်တွေရဲ့ spelling variation ကို အမြဲစစ်ဆေးရမည်။ နာမည်တစ်ခုကို စာလုံးပေါင်းမျိုးစုံနဲ့ ရှာရမည်။

```python
# Example: character name "ဟိုရှီနို" (Hoshino)
# Check for all possible OCR variations:
# - Missing ှ: ဟိုရီနို
# - Wrong consonant: ဟိုရှီဒို (န→ဒ)
```

### လဲ → လည်း (also/too/then)

OCR က လည်း ကို လဲ လို့ မှားတတ်တယ်။ ဒါပေမဲ့ **မေးခွန်းသဘောဆောင်တဲ့ လဲ** (e.g. ဘယ်မှာလဲ, ဘာလုပ်မှာလဲ) က မှန်တယ်။

| စစ်ဆေးရန် | မှား | မှန် |
|-----------|------|------|
| ကလဲ (also) | ကလဲ | ကလည်း |
| တော့လဲ | တော့လဲ | တော့လည်း |
| ရှိလဲ (also have) | ရှိလဲ | ရှိလည်း |
| ပါလဲ (also) | ပါလဲ | ပါလည်း |

BUT: ဘယ်မှာလဲ? (where?), ဘာလုပ်မှာလဲ? (what will do?) — ဒါတွေက **မှန်တယ်** (question particle)

### လ → ရ Confusion

OCR က လ နဲ့ ရ ကို မှားတတ်တယ်။

| မှား | မှန် | ဥပမာ |
|------|------|-------|
| **လျှောက်လို့လတယ်** | လျှောက်လို့ရတယ် | can walk |
| **ဖြစ်လနိုင်** | ဖြစ်ရနိုင် | can be/happen |
| **သွားလို့လ** | သွားလို့ရ | can go |
...
| **စီးကရတ်** | စီးကရက် |
| **ဝတ္တု** | ဝတ္ထု |
| **အဆုံးသတ်** (should be...) | အဆုံးသတ် can be correct |
